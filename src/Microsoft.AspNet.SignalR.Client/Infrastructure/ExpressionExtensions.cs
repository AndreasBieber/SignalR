...
namespace Microsoft.AspNet.SignalR.Client.Infrastructure
{
    internal static class ExpressionExtensions
    {
        ...
        public static void GetInvocationDetails<TContract, TResult>(this Expression<Func<TContract, TResult>> invocation,
        ...
        public static string GetMethodName<TContract>(this Expression<Func<TContract, Action>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T>(this Expression<Func<TContract, Action<T>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2>(
            this Expression<Func<TContract, Action<T1, T2>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2, T3>(
            this Expression<Func<TContract, Action<T1, T2, T3>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2, T3, T4>(
            this Expression<Func<TContract, Action<T1, T2, T3, T4>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2, T3, T4, T5>(
            this Expression<Func<TContract, Action<T1, T2, T3, T4, T5>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2, T3, T4, T5, T6>(
            this Expression<Func<TContract, Action<T1, T2, T3, T4, T5, T6>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }

        public static string GetMethodName<TContract, T1, T2, T3, T4, T5, T6, T7>(
            this Expression<Func<TContract, Action<T1, T2, T3, T4, T5, T6, T7>>> invocation)
        {
            return GetMethodNameFromExpression(invocation);
        }
